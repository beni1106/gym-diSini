  ...
  return (
    <div className="text-black p-5 w-3/4 h-[100vh]">
      ...
      <div className="border -2 bg-slate-900 flex justify-between w-full text-white rounded-lg p-3">
        <div
          className="border-2 pl-3 pr-3 pt-1 pb-1 rounded-2xl cursor-pointer hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-block"
      ...
      {/* {black for back to dashboard button} */}
      <Link to={"/Dashboard"}>
        <ArrowBackIcon />
        Back To Dashboard
      </Link>
      ...
      <div className="mt-5 w-1/2 flex gap-2">
        <input
          type="text"
          className="border-2 w-full p-2 rouded-lg"
          placeholder="Search By Name or Mobile No"
        />
        <div className="bg-slate-900 p-3 border-2 text-white rounded-lg cursor pointer hover:bg-gradient-to-r from-indigo-500 to-pink-500 hover:text-black">
          <SearchIcon />
        </div>
      </div>
      <div className="mt-5 text-xl flex justify-between text-slate-900">
        ...
        <div className="flex gap-5">
          ...
          <div
            className={`
              w-8 h-8 cursor-pointer border-2 flex items-center justify-center
