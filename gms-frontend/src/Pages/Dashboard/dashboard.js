    ...
    return (
        <div className='w-3/4 text-black p-5 relative'>
            <div className='w-full bg-slate-900 text-white rounded-lg flex p-3 justify-between items-center'>
                ...
                <img className='w-8 h-8 rounded-3xl border-2' src='https://us.123rf.com/450wm/zrzahid/zrzahid2408/zrzahid240891553/234754926-beautiful-professional-cartoon-character-design-vector-illustration.jpg?ver=6' alt='Image' />
